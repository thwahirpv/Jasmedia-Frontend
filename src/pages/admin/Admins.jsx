  ...
  return (
    <div className="w-full min-h-screen bg-agency-black p-6 md:p-10">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 gap-4">
        <div>
           <h1 className="text-3xl font-bold font-russo text-white">Admins</h1>
           <p className="text-gray-400 mt-1 font-opensans">Manage system administrators.</p>
        </div>
      </div>
      ...
      <div className="bg-white/5 rounded-2xl border border-white/10 p-6 backdrop-blur-sm">
        ...
        <AdminsList isModalOpen={isModalOpen} statusSelected={statusSelected} searchTerm={searchTerm} />
      </div>
      <AdminsForm setIsModalOpen={setIsModalOpen} isModalOpen={isModalOpen} />

      ...
      <div className="relative z-10 container mx-auto px-4 flex flex-col items-center text-center space-y-10">
        ...
        <div className="grid md:grid-cols-3 gap-6 w-full max-w-5xl mt-8">
          <motion.a
            ...
            className="p-6 bg-gray-50 rounded-2xl border border-gray-100 flex flex-col items-center gap-3 hover:shadow-lg transition-all cursor-pointer group"
          >
            <div className="w-10 h-10 rounded-full bg-green/10 flex items-center justify-center text-green group-hover:scale-110 transition-transform">
              <Mail size={20} />
            </div>
